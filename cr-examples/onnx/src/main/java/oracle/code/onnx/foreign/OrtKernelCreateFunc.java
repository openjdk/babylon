...
public final class OrtKernelCreateFunc {
    ...
    private static final MethodHandle UP$MH = onnxruntime_c_api_h.upcallHandle(OrtKernelCreateFunc.Function.class, "apply", $DESC);
     ...
     */
    public static MemorySegment invoke(MemorySegment funcPtr, MemorySegment kernel_create_func_state, MemorySegment info, MemorySegment kernel_out) {
        try {
