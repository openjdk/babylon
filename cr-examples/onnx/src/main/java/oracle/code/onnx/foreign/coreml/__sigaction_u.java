...
public class __sigaction_u {
    ...
    public static class __sa_handler {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(__sa_handler.Function.class, "apply", $DESC);
    ...
    public static class __sa_sigaction {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(__sa_sigaction.Function.class, "apply", $DESC);
