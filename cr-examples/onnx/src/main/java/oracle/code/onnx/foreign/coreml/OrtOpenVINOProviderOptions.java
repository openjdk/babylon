...
public class OrtOpenVINOProviderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        coreml_provider_factory_h.C_POINTER.withName("device_type"),
        coreml_provider_factory_h.C_CHAR.withName("enable_npu_fast_compile"),
        MemoryLayout.paddingLayout(7),
        coreml_provider_factory_h.C_POINTER.withName("device_id"),
        coreml_provider_factory_h.C_LONG.withName("num_of_threads"),
        coreml_provider_factory_h.C_POINTER.withName("cache_dir"),
        coreml_provider_factory_h.C_POINTER.withName("context"),
        coreml_provider_factory_h.C_CHAR.withName("enable_opencl_throttling"),
        coreml_provider_factory_h.C_CHAR.withName("enable_dynamic_shapes"),
