...
public class OrtTensorRTProviderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        coreml_provider_factory_h.C_INT.withName("device_id"),
        coreml_provider_factory_h.C_INT.withName("has_user_compute_stream"),
        coreml_provider_factory_h.C_POINTER.withName("user_compute_stream"),
        coreml_provider_factory_h.C_INT.withName("trt_max_partition_iterations"),
        coreml_provider_factory_h.C_INT.withName("trt_min_subgraph_size"),
        coreml_provider_factory_h.C_LONG.withName("trt_max_workspace_size"),
        coreml_provider_factory_h.C_INT.withName("trt_fp16_enable"),
        coreml_provider_factory_h.C_INT.withName("trt_int8_enable"),
        coreml_provider_factory_h.C_POINTER.withName("trt_int8_calibration_table_name"),
        coreml_provider_factory_h.C_INT.withName("trt_int8_use_native_calibration_table"),
        coreml_provider_factory_h.C_INT.withName("trt_dla_enable"),
        coreml_provider_factory_h.C_INT.withName("trt_dla_core"),
        coreml_provider_factory_h.C_INT.withName("trt_dump_subgraphs"),
        coreml_provider_factory_h.C_INT.withName("trt_engine_cache_enable"),
        MemoryLayout.paddingLayout(4),
        coreml_provider_factory_h.C_POINTER.withName("trt_engine_cache_path"),
        coreml_provider_factory_h.C_INT.withName("trt_engine_decryption_enable"),
        MemoryLayout.paddingLayout(4),
        coreml_provider_factory_h.C_POINTER.withName("trt_engine_decryption_lib_path"),
        coreml_provider_factory_h.C_INT.withName("trt_force_sequential_engine_build"),
        MemoryLayout.paddingLayout(4)
