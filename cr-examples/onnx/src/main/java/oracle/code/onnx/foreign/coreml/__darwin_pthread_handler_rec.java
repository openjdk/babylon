...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        coreml_provider_factory_h.C_POINTER.withName("__routine"),
        coreml_provider_factory_h.C_POINTER.withName("__arg"),
        coreml_provider_factory_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(__routine.Function.class, "apply", $DESC);
