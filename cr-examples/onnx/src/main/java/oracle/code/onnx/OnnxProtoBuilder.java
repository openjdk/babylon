...
public sealed class OnnxProtoBuilder<T extends OnnxProtoBuilder> {
    ...
    public static final class AttributeProto extends OnnxProtoBuilder<AttributeProto> {
    ...
    public static final class ValueInfoProto extends OnnxProtoBuilder<ValueInfoProto> {
    ...
    public static final class NodeProto extends OnnxProtoBuilder<NodeProto> {
    ...
    public static final class TrainingInfoProto extends OnnxProtoBuilder<TrainingInfoProto> {
    ...
    public static final class ModelProto extends OnnxProtoBuilder<ModelProto> {
    ...
    public static final class StringStringEntryProto extends OnnxProtoBuilder<StringStringEntryProto> {
    ...
    public static final class TensorAnnotation extends OnnxProtoBuilder<TensorAnnotation> {
    ...
    /// frameworks.
    public static final class GraphProto extends OnnxProtoBuilder<GraphProto> {
    ...
    public static final class TensorProto extends OnnxProtoBuilder<TensorProto> {
        ...
        public static final class Segment extends OnnxProtoBuilder<Segment> {
    ...
    public static final class SparseTensorProto extends OnnxProtoBuilder<SparseTensorProto> {
    ...
    /// dimension.
    public static final class TensorShapeProto extends OnnxProtoBuilder<TensorShapeProto> {

        public static final class Dimension extends OnnxProtoBuilder<Dimension> {
    ...
    public static final class TypeProto extends OnnxProtoBuilder<TypeProto> {

        public static final class Tensor extends OnnxProtoBuilder<Tensor> {
        ...
        /// repeated T
        public static final class Sequence extends OnnxProtoBuilder<Sequence> {
        ...
        /// map<K,V>
        public static final class Map extends OnnxProtoBuilder<Map> {
        ...
        public static final class Optional extends OnnxProtoBuilder<Optional> {
        ...
        public static final class SparseTensor extends OnnxProtoBuilder<SparseTensor> {
        ...
        public static final class Opaque extends OnnxProtoBuilder<Opaque> {
    ...
    public static final class OperatorSetIdProto extends OnnxProtoBuilder<OperatorSetIdProto> {
    ...
    public static final class FunctionProto extends OnnxProtoBuilder<FunctionProto> {
    ...
    @SuppressWarnings("unchecked")   T _f(int fieldIndex, IntSupplier value) {
