...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        coreml_provider_factory_h.C_LONG.withName("__sig"),
        coreml_provider_factory_h.C_POINTER.withName("__cleanup_stack"),
        MemoryLayout.sequenceLayout(8176, coreml_provider_factory_h.C_CHAR).withName("__opaque")
