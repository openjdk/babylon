...
public class OrtEpFactory {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        coreml_provider_factory_h.C_POINTER.withName("GetVendor"),
        coreml_provider_factory_h.C_POINTER.withName("GetSupportedDevices"),
        coreml_provider_factory_h.C_POINTER.withName("CreateEp"),
        coreml_provider_factory_h.C_POINTER.withName("ReleaseEp"),
        coreml_provider_factory_h.C_POINTER.withName("GetVendorId"),
        coreml_provider_factory_h.C_POINTER.withName("GetVersion"),
        coreml_provider_factory_h.C_POINTER.withName("ValidateCompiledModelCompatibilityInfo"),
        ...
        coreml_provider_factory_h.C_POINTER.withName("CreateDataTransfer"),
        coreml_provider_factory_h.C_POINTER.withName("IsStreamAware"),
    ...
    public static class GetVendor {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(GetVendor.Function.class, "apply", $DESC);
    ...
    public static class GetSupportedDevices {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(GetSupportedDevices.Function.class, "apply", $DESC);
    ...
    public static class CreateEp {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(CreateEp.Function.class, "apply", $DESC);
    ...
    public static class ReleaseEp {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(ReleaseEp.Function.class, "apply", $DESC);
     ...
     * }
     */
    public static class GetVendorId {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(GetVendorId.Function.class, "apply", $DESC);
    ...
    private static final long GetVendorId$OFFSET = 48;
    ...
    public static class GetVersion {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(GetVersion.Function.class, "apply", $DESC);
    ...
    private static final long GetVersion$OFFSET = 56;
     ...
     * }
     */
    public static class ValidateCompiledModelCompatibilityInfo {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(ValidateCompiledModelCompatibilityInfo.Function.class, "apply", $DESC);
    ...
    private static final long ValidateCompiledModelCompatibilityInfo$OFFSET = 64;
    ...
    private static final long CreateAllocator$OFFSET = 72;
    ...
    private static final long ReleaseAllocator$OFFSET = 80;
     ...
     * }
     */
    public static class CreateDataTransfer {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(CreateDataTransfer.Function.class, "apply", $DESC);
    ...
    private static final long CreateDataTransfer$OFFSET = 88;
     ...
     * }
     */
    public static class IsStreamAware {
        ...
        private static final MethodHandle UP$MH = coreml_provider_factory_h.upcallHandle(IsStreamAware.Function.class, "apply", $DESC);
    ...
    private static final long IsStreamAware$OFFSET = 96;
    ...
    private static final long CreateSyncStreamForDevice$OFFSET = 104;
