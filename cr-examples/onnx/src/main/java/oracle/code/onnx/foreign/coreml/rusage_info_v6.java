...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_billed_system_time"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_logical_writes"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_instructions"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_cycles"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_billed_energy"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_serviced_energy"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_runnable_time"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_flags"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_user_ptime"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_system_ptime"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_pinstructions"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_pcycles"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_energy_nj"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_penergy_nj"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_secure_time_in_system"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_neural_footprint"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        coreml_provider_factory_h.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, coreml_provider_factory_h.C_LONG_LONG).withName("ri_reserved")
