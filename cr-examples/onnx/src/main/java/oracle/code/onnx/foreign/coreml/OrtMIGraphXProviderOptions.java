...
public class OrtMIGraphXProviderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        coreml_provider_factory_h.C_INT.withName("migraphx_fp16_enable"),
        coreml_provider_factory_h.C_INT.withName("migraphx_fp8_enable"),
        coreml_provider_factory_h.C_INT.withName("migraphx_int8_enable"),
        coreml_provider_factory_h.C_INT.withName("migraphx_use_native_calibration_table"),
        MemoryLayout.paddingLayout(4),
        coreml_provider_factory_h.C_POINTER.withName("migraphx_int8_calibration_table_name"),
        coreml_provider_factory_h.C_INT.withName("migraphx_save_compiled_model"),
        MemoryLayout.paddingLayout(4),
        coreml_provider_factory_h.C_POINTER.withName("migraphx_save_model_path"),
        coreml_provider_factory_h.C_INT.withName("migraphx_load_compiled_model"),
        MemoryLayout.paddingLayout(4),
        coreml_provider_factory_h.C_POINTER.withName("migraphx_load_model_path"),
        coreml_provider_factory_h.C_BOOL.withName("migraphx_exhaustive_tune"),
        MemoryLayout.paddingLayout(7),
        coreml_provider_factory_h.C_LONG.withName("migraphx_mem_limit"),
        coreml_provider_factory_h.C_INT.withName("migraphx_arena_extend_strategy"),
        MemoryLayout.paddingLayout(4)
