...
ONNXRUNTIME_JAR=~/.m2/repository/com/microsoft/onnxruntime/onnxruntime/1.23.1/onnxruntime-1.23.1.jar
...
# Run the program
java  -Djava.library.path=$ONNXRUNTIME_JAR!/ai/onnxruntime/native/osx-aarch64/libonnxruntime.dylib \
