...
public class TextGutter extends JComponent {
    ...
    private final BabylonTextModelViewer lhs;
    private final BabylonTextModelViewer rhs;
    ...
    public TextGutter(BabylonTextModelViewer lhs, BabylonTextModelViewer rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    ...
    void paintNumbers(Graphics g, BabylonTextModelViewer tv, int col) {
