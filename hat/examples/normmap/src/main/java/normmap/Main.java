...
/**
 * Based on a demo presented at JVMLS 2025 conference by Emanuel Peter, when giving
 * The rest of this comment is based on Emanuel's original code.
 *
 ...
 *
 * The motivation for JVMLS 2025 was to present something that vectorizes
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Interrupted, terminating demo.");
        } finally {
...
/*    public static File getLocalFile(String name) {
        ...
        // via getResource.
        String file = //System.getProperty("test.src",
            "/Users/grfrost/github/babylon-grfrost-fork/hat/examples/normmap/src/main/resources/images/"+name;
    ...
    public static class State {
        ...
        public BufferedImage loadNormals(String name) {
            ...
            BufferedImage normalsLoaded = loadImage("/images/"+name);
