...
public sealed abstract class JavaOp extends ExternalizableOp {
     ...
     */
    public static final OpFactory JAVA_OP_FACTORY = CoreOp.CORE_OP_FACTORY.andThen(OpFactory.OP_FACTORY_MAP.get(JavaOp.class));
     ...
     * type elements.
     */
    public static final DialectFactory JAVA_DIALECT_FACTORY = new DialectFactory(JAVA_OP_FACTORY, JAVA_TYPE_FACTORY);
