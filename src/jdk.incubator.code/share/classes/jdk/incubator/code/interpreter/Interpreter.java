...
public final class Interpreter {
    ...
    Object invoke(T op,
                  Object... args) {
        return invoke(publicCodeLookup(), op, args);
    }
    ...
    Object invoke(T op,
                  Map<Value, Object> capturedValues,
                  List<Object> args) {
        return invoke(publicCodeLookup(), op, capturedValues, args);
    }
    ...
    // The following returns a lookup that is as close as possible to a public lookup.
    // Note: since the clases in this module are loaded by a different class loader than
    // the bootloader, we can't just use a public lookup.
    private static Lookup publicCodeLookup() {
        return MethodHandles.lookup()
                .dropLookupMode(Lookup.MODULE)
                .dropLookupMode(Lookup.ORIGINAL);
    }
}
