...
public class BoxingConversionTest {
    ...
    @IR("""
            func @"test2" (%0 : BoxingConversionTest, %1 : java.lang.Long)void -> {
                ...
                %4 : long = invoke %3 @"java.lang.Long::longValue(void):long";
                %5 : Var<long> = var %4 @"l";
                return;
            };
            """)
    ...
    @IR("""
            func @"test4" (%0 : BoxingConversionTest, %1 : java.lang.Object)void -> {
                ...
                %5 : long = invoke %4 @"java.lang.Long::longValue(void):long";
                %6 : Var<long> = var %5 @"l";
                return;
            };
            """)
    ...
    @IR("""
            func @"test5" (%0 : BoxingConversionTest, %1 : java.lang.Integer)void -> {
                ...
                %4 : int = constant @"1";
                %5 : int = invoke %3 @"java.lang.Integer::intValue(void):int";
                %6 : int = add %5 %4;
    ...
    @IR("""
            func @"test7" (%0 : BoxingConversionTest)void -> {
                %1 : BoxingConversionTest$Box = new @"BoxingConversionTest$Box::(void)";
                %2 : java.lang.Integer = field.load %1 @"BoxingConversionTest$Box::i:java.lang.Integer";
                %3 : int = constant @"1";
                %4 : int = invoke %2 @"java.lang.Integer::intValue(void):int";
                %5 : int = add %4 %3;
    ...
    @IR("""
            func @"test9" (%0 : BoxingConversionTest, %1 : [int], %2 : java.lang.Integer)void -> {
                ...
                %9 : int = invoke %8 @"java.lang.Integer::intValue(void):int";
                %10 : int = add %7 %9;
                array.store %5 %6 %10;
                return;
            };
            ...
            func @"test10" (%0 : BoxingConversionTest, %1 : boolean, %2 : java.lang.Integer)void -> {
                ...
                %5 : int = java.cexpression
                    ...
                    ()int -> {
                        ...
                        %8 : int = invoke %7 @"java.lang.Integer::intValue(void):int";
                        yield %8;
                    }
                    ()int -> {
                        %9 : int = constant @"2";
            ...
            func @"test15" (%0 : BoxingConversionTest, %1 : int, %2 : java.lang.Integer)void -> {
                ...
                %6 : int = java.switch.expression %5
                    ...
                    ()int -> {
                        ...
                        %11 : int = invoke %10 @"java.lang.Integer::intValue(void):int";
                        yield %11;
                    }
                    ()boolean -> {
    ...
    @IR("""
            func @"test16" (%0 : BoxingConversionTest, %1 : int, %2 : java.lang.Integer)void -> {
                ...
                %6 : int = java.switch.expression %5
                    ...
                    ()int -> {
                        %12 : java.lang.Integer = var.load %4;
                        %13 : int = invoke %12 @"java.lang.Integer::intValue(void):int";
                        yield %13;
                    };
                %14 : Var<int> = var %6 @"x";
                return;
    ...
    @IR("""
            func @"test17" (%0 : BoxingConversionTest, %1 : int)void -> {
                ...
                %13 : Var<java.lang.Integer> = var %4 @"x";
                return;
            };
            """)
    void test17(int i) {
    ...
    @IR("""
            func @"test21" (%0 : BoxingConversionTest, %1 : int, %2 : java.lang.Integer)void -> {
                ...
                %7 : int = invoke %6 @"java.lang.Integer::intValue(void):int";
                %8 : int = add %5 %7;
                %9 : Var<int> = var %8 @"l";
                return;
            };
    ...
    @IR("""
            func @"test26" (%0 : BoxingConversionTest, %1 : int)void -> {
                ...
                %3 : int = var.load %2;
                %4 : java.lang.Integer = invoke %3 @"java.lang.Integer::valueOf(int):java.lang.Integer";
                %5 : BoxingConversionTest$Box2 = new %4 @"BoxingConversionTest$Box2::(java.lang.Integer)";
                return;
            };
            """)
    void test26(int i) {
    ...
    @IR("""
            func @"test27" (%0 : BoxingConversionTest, %1 : int)void -> {
                ...
                %3 : int = var.load %2;
                %4 : int = var.load %2;
                %5 : BoxingConversionTest$Box2 = new %3 %4 @"BoxingConversionTest$Box2::(int, int, [java.lang.Integer])" @new.varargs="true";
                return;
            };
            """)
    void test27(int i) {
    ...
    @IR("""
            func @"test28" (%0 : BoxingConversionTest, %1 : int)void -> {
                ...
                %5 : int = var.load %2;
                %6 : java.lang.Integer = invoke %5 @"java.lang.Integer::valueOf(int):java.lang.Integer";
                %7 : BoxingConversionTest$Box2 = new %3 %4 %6 @"BoxingConversionTest$Box2::(int, int, [java.lang.Integer])" @new.varargs="true";
                return;
            };
            """)
    void test28(int i) {
    ...
    @IR("""
            func @"test29" (%0 : BoxingConversionTest, %1 : int)void -> {
                ...
                %7 : int = var.load %2;
                %8 : java.lang.Integer = invoke %7 @"java.lang.Integer::valueOf(int):java.lang.Integer";
                %9 : BoxingConversionTest$Box2 = new %3 %4 %6 %8 @"BoxingConversionTest$Box2::(int, int, [java.lang.Integer])" @new.varargs="true";
                return;
            };
            """)
    void test29(int i) {
    ...
    @IR("""
            func @"test33" (%0 : java.lang.Boolean)void -> {
                ...
                %3 : boolean = invoke %2 @"java.lang.Boolean::booleanValue(void):boolean";
                %4 : boolean = not %3;
