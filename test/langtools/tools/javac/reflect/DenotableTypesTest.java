...
public class DenotableTypesTest {
    ...
    @IR("""
            func @"test2" ()void -> {
                ...
                %4 : java.util.List<? extends java.lang.Number> = invoke %1 %3 @"java.util.List::of(java.lang.Object, java.lang.Object):java.util.List";
                return;
            };
            """)
    static void test2() {
    ...
    @IR("""
            func @"test5" ()void -> {
                %0 : java.util.List<? extends java.lang.Number> = constant @null;
                %1 : Var<java.util.List<? extends java.lang.Number>> = var %0 @"l";
                %2 : java.util.List<? extends java.lang.Number> = var.load %1;
                %3 : int = constant @"0";
    ...
    @IR("""
            func @"test6" ()void -> {
                %0 : java.util.List<? super java.lang.Number> = constant @null;
                %1 : Var<java.util.List<? super java.lang.Number>> = var %0 @"l";
                %2 : java.util.List<? super java.lang.Number> = var.load %1;
                %3 : int = constant @"0";
    ...
    @IR("""
            func @"test7" ()void -> {
                %0 : (DenotableTypesTest::test7(void):void)::<X> = constant @null;
                %1 : Var<(DenotableTypesTest::test7(void):void)::<X>> = var %0 @"x";
                %2 : (DenotableTypesTest::test7(void):void)::<X> = var.load %1;
    ...
    @CodeReflection
    @IR("""
            func @"test8" (%0 : java.util.List<? extends DenotableTypesTest$Adder<java.lang.Integer>>)void -> {
                %1 : Var<java.util.List<? extends DenotableTypesTest$Adder<java.lang.Integer>>> = var %0 @"list";
                %2 : java.util.List<? extends DenotableTypesTest$Adder<java.lang.Integer>> = var.load %1;
                %3 : int = constant @"0";
                %4 : DenotableTypesTest$Adder<java.lang.Integer> = invoke %2 %3 @"java.util.List::get(int):java.lang.Object";
                %5 : java.util.List<? extends DenotableTypesTest$Adder<java.lang.Integer>> = var.load %1;
                %6 : int = constant @"1";
    ...
    @CodeReflection
    @IR("""
            func @"test9" (%0 : java.util.List<? extends DenotableTypesTest$Box<java.lang.Integer>>)void -> {
                %1 : Var<java.util.List<? extends DenotableTypesTest$Box<java.lang.Integer>>> = var %0 @"list";
                %2 : java.util.List<? extends DenotableTypesTest$Box<java.lang.Integer>> = var.load %1;
                %3 : int = constant @"0";
    ...
    @IR("""
            func @"test10" ()void -> {
                java.try
                    ()void -> {
                        invoke @"DenotableTypesTest::g(void):void";
                        yield;
                    }
                    (%0 : java.lang.Exception)void -> {
                        ...
                        invoke %3 @"DenotableTypesTest$E::m(void):void";
                        yield;
                    };
                return;
            };
