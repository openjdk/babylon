...
public class QuotableIntersectionTest {
    @IR("""
            func @"f" ()void -> {
                  %0 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda ()void -> {
                      return;
                  };
                  return;
            };
    ...
    @IR("""
            func @"f" ()void -> {
                %0 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda ()int -> {
                    %2 : int = constant @"1";
                    return %2;
                };
                return;
    ...
    @IR("""
            func @"f" ()void -> {
                  %0 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda (%1 : int)int -> {
                      %2 : Var<int> = var %1 @"x";
                      %3 : int = var.load %2;
                      return %3;
                  };
    ...
    @IR("""
            func @"f" ()void -> {
                %0 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda (%1 : int, %2 : int)int -> {
                    %3 : Var<int> = var %1 @"x";
                    %4 : Var<int> = var %2 @"y";
                    %5 : int = var.load %3;
                    %6 : int = var.load %4;
    ...
    @IR("""
            func @"f" (%1 : Var<int>)void -> {
                %2 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda (%4 : int)int -> {
                    %5 : Var<int> = var %4 @"y";
                    %6 : int = var.load %1;
                    %7 : int = var.load %5;
                    %8 : int = add %6 %7;
    ...
    @IR("""
            func @"f" (%0 : QuotableIntersectionTest$Context)void -> {
                %1 : jdk.incubator.code.java.lang.reflect.code.Quotable = lambda (%3 : int)int -> {
                    %4 : Var<int> = var %3 @"z";
