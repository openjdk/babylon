...
public class LocalClassTest {
    ...
    @IR("""
            func @"testLocalNoCapture" (%0 : LocalClassTest)void -> {
                %1 : LocalClassTest::"1Foo" = new %0 @"LocalClassTest::\\"1Foo\\"::(LocalClassTest)";
                invoke %1 @"LocalClassTest::\\"1Foo\\"::m(void):void";
                return;
            };
            """)
    ...
    @IR("""
            func @"testAnonNoCapture" (%0 : LocalClassTest)void -> {
                %1 : LocalClassTest::"1" = new %0 @"LocalClassTest::\\"1\\"::(LocalClassTest)";
                invoke %1 @"LocalClassTest::\\"1\\"::m(void):void";
                return;
            };
            """)
    ...
    @IR("""
            func @"testLocalCaptureParam" (%0 : LocalClassTest, %1 : java.lang.String)java.lang.String -> {
                ...
                %4 : LocalClassTest::"2Foo" = new %0 %3 @"LocalClassTest::\\"2Foo\\"::(LocalClassTest, java.lang.String)";
                %5 : java.lang.String = invoke %4 @"LocalClassTest::\\"2Foo\\"::m(void):java.lang.String";
                return %5;
            };
            """)
    ...
    @IR("""
            func @"testAnonCaptureParam" (%0 : LocalClassTest, %1 : java.lang.String)java.lang.String -> {
                %2 : Var<java.lang.String> = var %1 @"s";
                %3 : java.lang.String = var.load %2;
                %4 : LocalClassTest::"2" = new %0 %3 @"LocalClassTest::\\"2\\"::(LocalClassTest, java.lang.String)";
                %5 : java.lang.String = invoke %4 @"LocalClassTest::\\"2\\"::m(void):java.lang.String";
                return %5;
            };
            """)
    ...
    @IR("""
            func @"testLocalCaptureParamAndField" (%0 : LocalClassTest, %1 : java.lang.String)java.lang.String -> {
                ...
                %6 : LocalClassTest::"3Foo" = new %0 %5 @"LocalClassTest::\\"3Foo\\"::(LocalClassTest, java.lang.String)";
                %7 : java.lang.String = invoke %6 @"LocalClassTest::\\"3Foo\\"::m(void):java.lang.String";
                return %7;
            };
            """)
    ...
    @IR("""
            func @"testAnonCaptureParamAndField" (%0 : LocalClassTest, %1 : java.lang.String)java.lang.String -> {
                ...
                %4 : Var<java.lang.String> = var %3 @"localConst";
                %5 : java.lang.String = var.load %2;
                %6 : LocalClassTest::"3" = new %0 %5 @"LocalClassTest::\\"3\\"::(LocalClassTest, java.lang.String)";
                %7 : java.lang.String = invoke %6 @"LocalClassTest::\\"3\\"::m(void):java.lang.String";
                return %7;
            };
            """)
    ...
    @IR("""
            func @"testLocalDependency" (%0 : LocalClassTest, %1 : int, %2 : int)void -> {
                ...
                %5 : int = var.load %3;
                %6 : int = var.load %4;
                %7 : LocalClassTest::"1Bar" = new %0 %5 %6 @"LocalClassTest::\\"1Bar\\"::(LocalClassTest, int, int)";
                return;
            };
            """)
    ...
    @IR("""
            func @"testAnonDependency" (%0 : LocalClassTest, %1 : int, %2 : int)void -> {
                ...
                %5 : int = var.load %3;
                %6 : int = var.load %4;
                %7 : LocalClassTest::"4" = new %0 %5 %6 @"LocalClassTest::\\"4\\"::(LocalClassTest, int, int)";
                return;
            };
            """)
