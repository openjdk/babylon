    ...
    @IR("""
            func @"f" (%0 : java.lang.Object)boolean -> {
                ...
                %5 : boolean = pattern.match %2
                    ()jdk.incubator.code.op.ExtendedOp$Pattern$Record<PatternTest2$R<PatternTest2$R::<T extends java.lang.Number>>> -> {
                        %6 : jdk.incubator.code.op.ExtendedOp$Pattern$Type<java.lang.Integer> = pattern.type @"i";
                        %7 : jdk.incubator.code.op.ExtendedOp$Pattern$Record<PatternTest2$R<PatternTest2$R::<T extends java.lang.Number>>> = pattern.record %6 @"PatternTest2$R(n : PatternTest2$R::<T extends java.lang.Number>)";
                        yield %7;
                    }
