...
class IntersectionTypeTest {
    ...
    @CodeReflection
    @IR("""
            func @"test1" (%0 : (IntersectionTypeTest::test1(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>)void -> {
                %1 : Var<(IntersectionTypeTest::test1(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>> = var %0 @"x";
                %2 : (IntersectionTypeTest::test1(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                invoke %2 @"IntersectionTypeTest$A::m_A(void):void";
                %3 : (IntersectionTypeTest::test1(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %4 : IntersectionTypeTest$B = cast %3 @"IntersectionTypeTest$B";
                invoke %4 @"IntersectionTypeTest$B::m_B(void):void";
                %5 : (IntersectionTypeTest::test1(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %6 : IntersectionTypeTest$C = cast %5 @"IntersectionTypeTest$C";
                invoke %6 @"IntersectionTypeTest$C::m_C(void):void";
                return;
            };
            """)
    ...
    @CodeReflection
    @IR("""
            func @"test2" (%0 : (IntersectionTypeTest::test2(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>)void -> {
                %1 : Var<(IntersectionTypeTest::test2(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>> = var %0 @"x";
                %2 : (IntersectionTypeTest::test2(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %3 : java.lang.Object = field.load @"IntersectionTypeTest$A::f_A:java.lang.Object";
                %4 : Var<java.lang.Object> = var %3 @"oA";
                %5 : (IntersectionTypeTest::test2(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %6 : java.lang.Object = field.load @"IntersectionTypeTest$B::f_B:java.lang.Object";
                %7 : Var<java.lang.Object> = var %6 @"oB";
                %8 : (IntersectionTypeTest::test2(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
    ...
    @CodeReflection
    @IR("""
            func @"test3" (%0 : (IntersectionTypeTest::test3(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>)void -> {
                %1 : Var<(IntersectionTypeTest::test3(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>> = var %0 @"x";
                %2 : (IntersectionTypeTest::test3(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %3 : Var<IntersectionTypeTest$A> = var %2 @"rec$";
                %4 : java.lang.Runnable = lambda ()void -> {
                    %5 : IntersectionTypeTest$A = var.load %3;
                    invoke %5 @"IntersectionTypeTest$A::m_A(void):void";
                    return;
                };
                %6 : Var<java.lang.Runnable> = var %4 @"rA";
                %7 : (IntersectionTypeTest::test3(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                ...
                %10 : java.lang.Runnable = lambda ()void -> {
                    ...
                    invoke %11 @"IntersectionTypeTest$B::m_B(void):void";
                    return;
                };
                %12 : Var<java.lang.Runnable> = var %10 @"rB";
                %13 : (IntersectionTypeTest::test3(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                ...
                %16 : java.lang.Runnable = lambda ()void -> {
                    ...
                    invoke %17 @"IntersectionTypeTest$C::m_C(void):void";
                    return;
                };
    ...
    @CodeReflection
    @IR("""
            func @"test4" (%0 : (IntersectionTypeTest::test4(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>)void -> {
                %1 : Var<(IntersectionTypeTest::test4(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A>> = var %0 @"x";
                %2 : (IntersectionTypeTest::test4(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                invoke %2 @"IntersectionTypeTest::g_A(IntersectionTypeTest$A):void";
                %3 : (IntersectionTypeTest::test4(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %4 : IntersectionTypeTest$B = cast %3 @"IntersectionTypeTest$B";
                invoke %4 @"IntersectionTypeTest::g_B(IntersectionTypeTest$B):void";
                %5 : (IntersectionTypeTest::test4(IntersectionTypeTest$A):void)::<X extends IntersectionTypeTest$A> = var.load %1;
                %6 : IntersectionTypeTest$C = cast %5 @"IntersectionTypeTest$C";
    ...
    @IR("""
            func @"test7" (%0 : IntersectionTypeTest$E1, %1 : IntersectionTypeTest$E2)void -> {
                ...
                %10 : java.lang.Runnable = lambda ()void -> {
                    ...
                    invoke %11 @"IntersectionTypeTest$A::m_A(void):void";
                    return;
                };
                ...
                %16 : java.lang.Runnable = lambda ()void -> {
                    ...
                    invoke %17 @"IntersectionTypeTest$B::m_B(void):void";
                    return;
                };
                ...
                %22 : java.lang.Runnable = lambda ()void -> {
                    ...
                    invoke %23 @"IntersectionTypeTest$C::m_C(void):void";
                    return;
                };
